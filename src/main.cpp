...
//---------------------------------------------------------------------------------------------------
TEST_F(Test_HelloClass, sub)
{
	obj.sub(5);
	cout << "Value is : " << obj.a << endl;
	EXPECT_TRUE(obj.a == 5) << "Error a != 5 : a = " << obj.a << std::endl;
}
//---------------------------------------------------------------------------------------------------

//---------------------------------------------------------------------------------------------------
TEST_F(Test_HelloClass, falsetest)
{
	cout << "Value is : " << obj.a << endl;
	EXPECT_TRUE(obj.a == 5) << "Error a != 5 : a = " << obj.a << std::endl;
}
...
//---------------------------------------------------------------------------------------------------
TEST_F(Test_HelloClass, DISABLED_disabledtest)
{
